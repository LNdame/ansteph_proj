...
public class AnimationFactory implements IAnimationFactory {
    ...
    @Override
    public void fadeInView(View target, long duration, final IAnimationFactory.AnimationStartListener listener) {
    ...
    @Override
    public void fadeOutView(View target, long duration, final IAnimationFactory.AnimationEndListener listener) {
