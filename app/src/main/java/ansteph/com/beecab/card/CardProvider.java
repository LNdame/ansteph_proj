...
public class CardProvider <T extends CardProvider> extends Observable {
    ...
    private String mPickupAdd;
    private String mDestinationAdd;
    private String mFare;
    private String mTime;
    private String mTimeBid;
...
/////////////////////////////////////////////////////////////////
    ...
    protected void onCreated() {
        setTitleResourceColor(R.color.black_button);
        setSubtitleResourceColor(R.color.grey_title);
        setDividerResourceColor(R.color.grey_title);
    ...
    /////////////////////////////////////////////////////////////////
    //
    //      Functions related to setting and getting the properties of the new added field.
    //
    /////////////////////////////////////////////////////////////////
     ...
     *
     * @param mTimeBid to set.
     * @return the renderer.
     */
    @NonNull
    public T setTimeBid(@StringRes final int mTimeBid) {
        return setTimeBid(getContext().getString(mTimeBid));
    ...
    public T setTimeBid(@NonNull final String mTimeBid) {
        this.mTimeBid = mTimeBid;
        notifyDataSetChanged();
        return (T) this;
    }

    @NonNull
    public T setTime(@StringRes final int mTime) {
       return setTime(getContext().getString(mTime));

    }

    @SuppressWarnings("unchecked")
    public T setTime(@NonNull final String mTime) {
        this.mTime = mTime;
        notifyDataSetChanged();
        return (T) this;
    }
    ...
    @NonNull
    public T setFare(@StringRes final int mFare) {
        return setFare(getContext().getString(mFare));

    }

    @SuppressWarnings("unchecked")
    public T setFare(@NonNull final String mFare) {
        this.mFare = mFare;
        notifyDataSetChanged();
        return (T) this;
    }
    ...
    @NonNull
    public T setPickupAdd(@StringRes final int mPickupAdd) {
       return setPickupAdd(getContext().getString(mPickupAdd));

    }

    @SuppressWarnings("unchecked")
    public T setPickupAdd(@NonNull final String mPickupAdd) {
        this.mPickupAdd = mPickupAdd;
        notifyDataSetChanged();
        return (T) this;
    }

    @NonNull
    public T setDestinationAdd(@StringRes final int mDestinationAdd) {
        return setDestinationAdd(getContext().getString(mDestinationAdd));

    }

    @SuppressWarnings("unchecked")
    public T setDestinationAdd(@NonNull final String mDestinationAdd) {
        this.mDestinationAdd = mDestinationAdd;
        notifyDataSetChanged();
        return (T) this;
    }
    ...
    public void render(@NonNull final View view, @NonNull final Card card) {
        ...
        final TextView txtdestTitle = findViewById(view, R.id.desTitle, TextView.class);

        if(txtdestTitle!=null)
        {
            txtdestTitle.setText("Destination");
            txtdestTitle.setTextColor(getTitleColor());
        }

        final TextView txtpuTitle = findViewById(view, R.id.puTitle, TextView.class);
        if(txtpuTitle!=null)
        {txtpuTitle.setText("Pickup");
        txtpuTitle.setTextColor(getTitleColor());
        }

       // pickupAdd;
        final TextView pickupAdd = findViewById(view, R.id.PickupAdd, TextView.class);
        if (pickupAdd != null) {
            pickupAdd.setText(getPickupAdd());
            pickupAdd.setTextColor(getTitleColor());
            pickupAdd.setGravity(getTitleGravity());
        }

      //  destinationAdd;
        final TextView destinationAdd = findViewById(view, R.id.DestinationAdd, TextView.class);
        if (destinationAdd != null) {
            destinationAdd.setText(getDestinationAdd());
            destinationAdd.setTextColor(getTitleColor());
            destinationAdd.setGravity(getTitleGravity());
        }
        // fare;
        final TextView fare = findViewById(view, R.id.fare, TextView.class);
        if (fare != null) {
            fare.setText(getFare());
            fare.setTextColor(getDescriptionColor());
            fare.setGravity(getTitleGravity());
        }

      //  time;
        final TextView time = findViewById(view, R.id.txtputime, TextView.class);
        if (time != null) {
            time.setText(getTime());
            time.setTextColor(getTitleColor());
            time.setGravity(getTitleGravity());
        }

      //  timeBid;

        final TextView timeBid = findViewById(view, R.id.txttimetobid, TextView.class);
        if (timeBid != null) {
            timeBid.setText(getTimeBid());
            timeBid.setTextColor(getTitleColor());
            timeBid.setGravity(getTitleGravity());
        }
